...
int main(int argc, char **argv)
{
  ...
  ros::spin();
    ...
    // Stop all threads
  SLAM.Shutdown();
   // Save camera trajectory as TUM format
  SLAM.SaveTrajectoryEuRoC("ros-mono-imu-Trajectory.txt");
  // Save keyframe trajectory as TUM format
  SLAM.SaveKeyFrameTrajectoryEuRoC("mono-imu-KeyFrameTrajectory.txt");
